...
export default function SelectPlan({ updateFormData, formData, NavigationButtons }) {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold text-center mb-4">Select Your Plan</h1>
            <p className="text-center text-gray-400 mb-6">Choose the plan that best fits your needs.</p>
